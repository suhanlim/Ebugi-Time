...
// :{user: unknown, props:unknown,  userImage: string, setModal: Dispatch<SetStateAction>}
const MyPagePostsModal = () => {
  ...
  return (
    <ModalContents onClick={handleModalClick}>
      ...
      >
        ...
        <br />
        <button
          className={like ? "btn btn-error" : "btn btn-error btn-outline"}
          onClick={() => {
            setLike(!like);
          }}
        >
        ...
        <button
          className={scrap ? "btn btn-warning" : "btn btn-warning btn-outline"}
          onClick={() => {
            setScrap(!scrap);
          }}
        >
          스크랩 : {props.scrapCount}
        </button>{" "}
      </div>
